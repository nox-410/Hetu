...
class ImageNetDataLoader(Op):
    ...
    def __init__(self, root, batch_size, image):
        ...
        self.train_data = ImageFolder(osp.join(root, "train"), self.transform)
        self.test_data = ImageFolder(osp.join(root, "val"), self.transform_test)
...
# a = ImageNetDataLoader("~/imagenet", 32, True)
# a.backward_hook(0, 1)
# import tqdm
